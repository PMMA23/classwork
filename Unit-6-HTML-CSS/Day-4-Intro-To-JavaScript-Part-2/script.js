...
function varTest() {
  // variables defined in a block are usually only inside the block or block within it 
  let num = 10; // not avaliable outside this block
  var someVariable = 10; // var defined is known outside the bock it is defined within 
}
console.log(someVariable contains: ${someVariable})
console.log(num contains: ${num}) // error 
/**
 ...
 * == is loose equality - values are the same but the tyoes don't matter
 * === is strict equality- values and the tyoes must be the same 
 * @param {Object} x
 * @param {Object} y
 */
