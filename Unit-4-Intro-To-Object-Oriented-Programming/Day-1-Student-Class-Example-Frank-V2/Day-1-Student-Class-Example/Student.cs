...
public class Student
{
    ...
    // As the class designer, you decide what you need to properly initalize objects of your class
    // Meaning you decide how many constructors you need, can have multiple or how users of the class initilizes your objects 
    //
    // Do we want to allow an object with default vaules
    //      Does it make sense to have a default student name and default scores

    public Student(string theName) // 1- arg ctor to accept name only 

    {
        studentName = theName;          // Assign the name passed to the ctor our studentName
        testScores = new List<int>();   // Define and assign an empty list to testscores 
    }
