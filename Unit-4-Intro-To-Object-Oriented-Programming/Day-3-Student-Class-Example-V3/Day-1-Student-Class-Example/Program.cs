...
//  ClassName objName = new ClassName(initial-name, initial-scores)    
    ...
    //      primitive types (int, double, bool, etc) all methods to 
    //      convert them to strings
    //
    //      object must have a method defined in their class to
    //      return a string verison of its data
    //
    //      if a class does not have a ToString()
    //
    ...
    newScores.Add(0);
    aStudent2.SetTestScores(newScores);
    aStudent2.ShowStudent();
