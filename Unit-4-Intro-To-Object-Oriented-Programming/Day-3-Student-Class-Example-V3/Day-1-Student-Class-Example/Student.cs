 ...
 *******************************************************************************************/
    ...
    /********************************************************************************************
     * Getters and Setters to allow access to our private dat
     *
    ...
    {
        return testScores; // return the value in this private data memeber
    }
    ...
    // overide indicates you are prociding a method that overrides standard C# behavior 
    //      the word override is optional 
    // toString() should return a string representation of the data in the class
    //m     and accept no parameters
    public override string ToString()
    {
        // Define a variable to ho;d the return value 
        string theData = "";
        theData = "$Name: {studentName}";
        theData += $"Scores: {testScores}";
